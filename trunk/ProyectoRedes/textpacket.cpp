...
void TextPacket::setRowPackect(int row, int col)
{
    ...
    QString cwr = "      "  + QString::number(listaPacket[row].getCWR()) + " = " + "CWR (Congestion Window Reduced) <br>";
    QString ece = "      "  + QString::number(listaPacket[row].getECE()) + " = " + "ECE (ECN-Echo) <br>";
    QString urg = "      "  + QString::number(listaPacket[row].getURG()) + " = " + "URG (Urgent) <br>";
    QString ack = "      "  + QString::number(listaPacket[row].getACK()) + " = " + "ACK (Acknowledgement) <br>";
    QString psh = "      "  + QString::number(listaPacket[row].getPUSH()) + " = " + "PSH (Push) <br>";
    QString rst = "      "  + QString::number(listaPacket[row].getRST()) + " = " + "RST (Reset) <br>";
    QString syn = "      "  + QString::number(listaPacket[row].getSYN()) + " = " + "Syn (Syn) <br>";
    QString fin = "      "  + QString::number(listaPacket[row].getFIN()) + " = " + "Fin (Fin) <br>";

    QString packetReconocio = "";
    if( listaPacket[row].getAcusado() != -100 )
        packetReconocio = "Este paquete reconoce recepción de fragmento: " + QString::number(listaPacket[row].getAcusado()) + "<br>";
